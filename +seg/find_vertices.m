function [ Vdat ] = find_vertices( L, threeFold, very_far, connectivity)
%
% Parameters
% ----------
% L : segmentation image
%   L(i,j) returns the index of the segmented object
% threeFold : 
%   
% very_far : float
%   threshold maximum distance to consider a pair of cells to be
%   adjacent
% connectivity : 4 or 8 or higher (default=8)
%
...
if (nargin == 1 || threeFold == 0)
    CC = bwconncomp(seg.findBranchPoints( L==0 ), connectivity);
